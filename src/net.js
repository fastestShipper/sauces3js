...
import { CLASS_LIST, CERNUNNOS } from './rpg/classes.js?v=20260708s';
...
import { cloneSkinned } from './npcs.js?v=20260708s';
import { equipWeapon, attackClipName, ATTACK_SPEED } from './weapons.js?v=20260708s';
import { showBubble } from './chat.js?v=20260708s';
import { WS_URL } from './rpg/account.js?v=20260708s';
