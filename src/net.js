...
import { composeCharacter } from './rpg/charcustom.js?v=20260709g35';
import { CLASS_LIST, CERNUNNOS } from './rpg/classes.js?v=20260709g35';
...
import { makeNametag } from './nametag.js?v=20260709g35';
import { cloneSkinned } from './npcs.js?v=20260709g35';
import { equipWeapon, attackClipName, comboClips, ATTACK_SPEED, attackFollowupClipName, attackReleaseDelay } from './weapons.js?v=20260709g35';
import { showBubble } from './chat.js?v=20260709g35';
import { WS_URL } from './rpg/account.js?v=20260709g35';
import { combatActionWindows, SKILL_TYPES, skillAnimSpeed, skillClipCandidates, skillFollowupClipCandidates, skillReleaseDelay, skillUsesHeavyWindow } from './animmap.js?v=20260709g35';
import { plantClip } from './animclip.js?v=20260709g35';
...
export class Net {
  ...
  _onMsg(m) {
    if (m.t === 'corr') {
      ...
      if (this.onMobAttack) this.onMobAttack(m.id, { target: m.target, ms: m.ms });
    }
    else if (m.t === 'phit') {
