...
import { City, mulberry32, ROAD_Y, WALK_Y, cropZoneData, WORLD_ANCHOR, WORLD_RADIUS } from './citygen.js?v=20260708k';
import { buildBuildings, buildRoads, buildParks } from './citymesh.js?v=20260708k';
import { GrassSystem } from './veg/grass.js?v=20260708k';
import { buildFlowerTuft } from './veg/flowers.js?v=20260708k';
import { Player } from './player.js?v=20260708k';
import { MiniMap } from './minimap.js?v=20260708k';
import { StreetLife } from './npcs.js?v=20260708k';
import { sanitizeImported } from './glbutil.js?v=20260708k';
import { buildToonLamp, buildToonBench, buildToonHydrant, buildToonBin, buildToonStreetSign, buildToonPlanter } from './props.js?v=20260708k';
import { Net } from './net.js?v=20260708k';
import { ChatUI, showBubble } from './chat.js?v=20260708k';
import { CLASS_LIST, CERNUNNOS, classById } from './rpg/classes.js?v=20260708k';
import { authRequest } from './rpg/account.js?v=20260708k';
import { MobField } from './rpg/mobs.js?v=20260708k';
import { Inventory } from './rpg/loot.js?v=20260708k';
import { HUD, Progress, QuestLog } from './rpg/hud.js?v=20260708k';
import { Combat } from './rpg/combat.js?v=20260708k';
import { applyWeaponTier, makeCharAura, updateAura } from './rpg/fx.js?v=20260708k';
import { Effects } from './rpg/effects.js?v=20260708k';
import { attachWeaponByName } from './weapons.js?v=20260708k';
import { createTextureKit, createToonSkyTexture, createGroundVariationTexture } from './worldmat.js?v=20260708k';
import { buildPoiSigns, installPoiInteractions, loadPublicPois } from './pois.js?v=20260708k';
import { createTrailerMode, createTrailerNet, getTrailerAuth, getTrailerChoice, getTrailerConfig } from './trailer.js?v=20260708k';
import { SocialPanel } from './social.js?v=20260708k';
import { SkillSystem } from './rpg/skills.js?v=20260708k';
import { rollDrops, Wallet } from './rpg/economy.js?v=20260708k';
import { createSfx } from './sfx.js?v=20260708k';
import { installTouchControls } from './touch.js?v=20260708k';
