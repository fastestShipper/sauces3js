...
import { City, mulberry32, ROAD_Y, WALK_Y, cropZoneData, WORLD_ANCHOR, WORLD_RADIUS } from './citygen.js?v=20260708z';
import { buildBuildings, buildRoads, buildParks } from './citymesh.js?v=20260708z';
import { GrassSystem } from './veg/grass.js?v=20260708z';
import { buildFlowerTuft } from './veg/flowers.js?v=20260708z';
import { Player } from './player.js?v=20260708z';
import { MiniMap } from './minimap.js?v=20260708z';
import { StreetLife } from './npcs.js?v=20260708z';
import { sanitizeImported } from './glbutil.js?v=20260708z';
import { buildToonLamp, buildToonBench, buildToonHydrant, buildToonBin, buildToonStreetSign, buildToonPlanter } from './props.js?v=20260708z';
import { Net } from './net.js?v=20260708z';
import { ChatUI, showBubble } from './chat.js?v=20260708z';
import { CLASS_LIST, CERNUNNOS, classById } from './rpg/classes.js?v=20260708z';
import { composeCharacter, sanitizeCustom, defaultCustom, RIGS, RIG_IDS, ACCESSORIES, ACC_IDS, PALETTES_BY_CLASS } from './rpg/charcustom.js?v=20260708z';
import { equipWeapon } from './weapons.js?v=20260708z';
import { authRequest } from './rpg/account.js?v=20260708z';
import { MobField } from './rpg/mobs.js?v=20260708z';
import { Inventory } from './rpg/loot.js?v=20260708z';
import { HUD, Progress, QuestLog } from './rpg/hud.js?v=20260708z';
import { Combat } from './rpg/combat.js?v=20260708z';
import { applyWeaponTier, makeCharAura, updateAura } from './rpg/fx.js?v=20260708z';
import { Effects } from './rpg/effects.js?v=20260708z';
import { attachWeaponByName } from './weapons.js?v=20260708z';
import { createTextureKit, createToonSkyTexture, createGroundVariationTexture } from './worldmat.js?v=20260708z';
import { buildPoiSigns, installPoiInteractions, loadPublicPois } from './pois.js?v=20260708z';
import { createTrailerMode, createTrailerNet, getTrailerAuth, getTrailerChoice, getTrailerConfig } from './trailer.js?v=20260708z';
import { SocialPanel } from './social.js?v=20260708z';
import { SkillSystem } from './rpg/skills.js?v=20260708z';
import { rollDrops, Wallet } from './rpg/economy.js?v=20260708z';
import { createSfx } from './sfx.js?v=20260708z';
import { installTouchControls } from './touch.js?v=20260708z';
import { createIntroScene } from './introscene.js?v=20260708z';

const APP_VERSION = '20260708z';
