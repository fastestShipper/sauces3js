...
import { City, mulberry32, ROAD_Y, WALK_Y, cropZoneData, WORLD_ANCHOR, WORLD_RADIUS } from './citygen.js?v=20260707e';
import { buildBuildings, buildRoads, buildParks } from './citymesh.js?v=20260707e';
import { GrassSystem } from './veg/grass.js?v=20260707e';
import { buildFlowerTuft } from './veg/flowers.js?v=20260707e';
import { Player } from './player.js?v=20260707e';
import { MiniMap } from './minimap.js?v=20260707e';
import { StreetLife } from './npcs.js?v=20260707e';
import { sanitizeImported } from './glbutil.js?v=20260707e';
import { buildToonLamp, buildToonBench, buildToonHydrant, buildToonBin, buildToonStreetSign, buildToonPlanter } from './props.js?v=20260707e';
import { Net } from './net.js?v=20260707e';
import { ChatUI, showBubble } from './chat.js?v=20260707e';
import { CLASS_LIST, CERNUNNOS } from './rpg/classes.js?v=20260707e';
import { authRequest } from './rpg/account.js?v=20260707e';
import { MobField } from './rpg/mobs.js?v=20260707e';
import { Inventory } from './rpg/loot.js?v=20260707e';
import { HUD, Progress, QuestLog } from './rpg/hud.js?v=20260707e';
import { Combat } from './rpg/combat.js?v=20260707e';
import { applyWeaponTier, makeCharAura, updateAura } from './rpg/fx.js?v=20260707e';
import { Effects } from './rpg/effects.js?v=20260707e';
import { attachWeaponByName } from './weapons.js?v=20260707e';
import { createTextureKit, createToonSkyTexture, createGroundVariationTexture } from './worldmat.js?v=20260707e';
import { buildPoiSigns, installPoiInteractions, loadPublicPois } from './pois.js?v=20260707e';
import { createTrailerMode, createTrailerNet, getTrailerAuth, getTrailerChoice, getTrailerConfig } from './trailer.js?v=20260707e';
import { SocialPanel } from './social.js?v=20260707e';
import { SkillSystem } from './rpg/skills.js?v=20260707e';
import { rollDrops, Wallet } from './rpg/economy.js?v=20260707e';
import { createSfx } from './sfx.js?v=20260707e';
import { installTouchControls } from './touch.js?v=20260707e';

const APP_VERSION = '20260707e';
