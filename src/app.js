...
import { MiniMap } from './minimap.js?v=20260710g53';
import { StreetLife } from './npcs.js?v=20260710g53';
import { sanitizeImported } from './glbutil.js?v=20260710g53';
import { buildToonLamp, buildToonBench, buildToonHydrant, buildToonBin, buildToonStreetSign, buildToonPlanter } from './props.js?v=20260710g53';
import { Net } from './net.js?v=20260710g53';
import { ChatUI, showBubble } from './chat.js?v=20260710g53';
import { CLASS_LIST, CERNUNNOS, classById } from './rpg/classes.js?v=20260710g53';
import { composeCharacter, sanitizeCustom, defaultCustom, RIGS, RIG_IDS, ACCESSORIES, ACC_IDS, PALETTES_BY_CLASS } from './rpg/charcustom.js?v=20260710g53';
import { equipWeapon } from './weapons.js?v=20260710g53';
import { authRequest, privyAuthRequest, loadPrivy, PRIVY_APP_ID } from './rpg/account.js?v=20260710g53';
import { MobField, warmMobAssets } from './rpg/mobs.js?v=20260710g53';
import { Inventory } from './rpg/loot.js?v=20260710g53';
import { HUD, Progress, QuestLog, hpMaxForLevel, xpNextForLevel } from './rpg/hud.js?v=20260710g53';
import { Combat } from './rpg/combat.js?v=20260710g53';
import { applyWeaponTier, makeCharAura, updateAura } from './rpg/fx.js?v=20260710g53';
import { Effects } from './rpg/effects.js?v=20260710g53';
import { attachWeaponByName } from './weapons.js?v=20260710g53';
import { createTextureKit, createToonSkyTexture, createGroundVariationTexture } from './worldmat.js?v=20260710g53';
import { buildPoiSigns, installPoiInteractions, loadPublicPois } from './pois.js?v=20260710g53';
import { createTrailerMode, createTrailerNet, getTrailerAuth, getTrailerChoice, getTrailerConfig } from './trailer.js?v=20260710g53';
import { SocialPanel, showSocialInvite } from './social.js?v=20260710g53';
import { SkillSystem } from './rpg/skills.js?v=20260710g53';
import { goldRewardMultiplier, materialGoldValue, rollDrops, Wallet } from './rpg/economy.js?v=20260710g53';
import { createSfx } from './sfx.js?v=20260710g53';
import { installTouchControls } from './touch.js?v=20260710g53';
import { createIntroScene } from './introscene.js?v=20260710g53';
import { styleCarShell } from './carstyle.js?v=20260710g53';
import { actionLabel, createKeybindsPanel, keybindChangeEvent, matchesAction } from './keybinds.js?v=20260710g53';
import { FrameMeter, fpsBand } from './perf.js?v=20260710g53';

const APP_VERSION = '20260710g53';
