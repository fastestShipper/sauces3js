...
import { City, mulberry32, ROAD_Y, WALK_Y, cropZoneData, WORLD_ANCHOR, WORLD_RADIUS } from './citygen.js?v=20260709j';
import { buildBuildings, buildRoads, buildParks } from './citymesh.js?v=20260709j';
import { GrassSystem } from './veg/grass.js?v=20260709j';
import { buildFlowerTuft } from './veg/flowers.js?v=20260709j';
import { Player } from './player.js?v=20260709j';
import { MiniMap } from './minimap.js?v=20260709j';
import { StreetLife } from './npcs.js?v=20260709j';
import { sanitizeImported } from './glbutil.js?v=20260709j';
import { buildToonLamp, buildToonBench, buildToonHydrant, buildToonBin, buildToonStreetSign, buildToonPlanter } from './props.js?v=20260709j';
import { Net } from './net.js?v=20260709j';
import { ChatUI, showBubble } from './chat.js?v=20260709j';
import { CLASS_LIST, CERNUNNOS, classById } from './rpg/classes.js?v=20260709j';
import { composeCharacter, sanitizeCustom, defaultCustom, RIGS, RIG_IDS, ACCESSORIES, ACC_IDS, PALETTES_BY_CLASS } from './rpg/charcustom.js?v=20260709j';
import { equipWeapon } from './weapons.js?v=20260709j';
import { authRequest } from './rpg/account.js?v=20260709j';
import { MobField } from './rpg/mobs.js?v=20260709j';
import { Inventory } from './rpg/loot.js?v=20260709j';
import { HUD, Progress, QuestLog } from './rpg/hud.js?v=20260709j';
import { Combat } from './rpg/combat.js?v=20260709j';
import { applyWeaponTier, makeCharAura, updateAura } from './rpg/fx.js?v=20260709j';
import { Effects } from './rpg/effects.js?v=20260709j';
import { attachWeaponByName } from './weapons.js?v=20260709j';
import { createTextureKit, createToonSkyTexture, createGroundVariationTexture } from './worldmat.js?v=20260709j';
import { buildPoiSigns, installPoiInteractions, loadPublicPois } from './pois.js?v=20260709j';
import { createTrailerMode, createTrailerNet, getTrailerAuth, getTrailerChoice, getTrailerConfig } from './trailer.js?v=20260709j';
import { SocialPanel } from './social.js?v=20260709j';
import { SkillSystem } from './rpg/skills.js?v=20260709j';
import { rollDrops, Wallet } from './rpg/economy.js?v=20260709j';
import { createSfx } from './sfx.js?v=20260709j';
import { installTouchControls } from './touch.js?v=20260709j';
import { createIntroScene } from './introscene.js?v=20260709j';
import { styleCarShell } from './carstyle.js?v=20260709j';

const APP_VERSION = '20260709j';
