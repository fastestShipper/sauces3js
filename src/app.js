...
import { City, mulberry32, ROAD_Y, WALK_Y, cropZoneData, WORLD_ANCHOR, WORLD_RADIUS } from './citygen.js?v=20260708v';
import { buildBuildings, buildRoads, buildParks } from './citymesh.js?v=20260708v';
import { GrassSystem } from './veg/grass.js?v=20260708v';
import { buildFlowerTuft } from './veg/flowers.js?v=20260708v';
import { Player } from './player.js?v=20260708v';
import { MiniMap } from './minimap.js?v=20260708v';
import { StreetLife } from './npcs.js?v=20260708v';
import { sanitizeImported } from './glbutil.js?v=20260708v';
import { buildToonLamp, buildToonBench, buildToonHydrant, buildToonBin, buildToonStreetSign, buildToonPlanter } from './props.js?v=20260708v';
import { Net } from './net.js?v=20260708v';
import { ChatUI, showBubble } from './chat.js?v=20260708v';
import { CLASS_LIST, CERNUNNOS, classById } from './rpg/classes.js?v=20260708v';
import { composeCharacter, sanitizeCustom, defaultCustom, RIGS, RIG_IDS, ACCESSORIES, ACC_IDS, PALETTES_BY_CLASS } from './rpg/charcustom.js?v=20260708v';
import { equipWeapon } from './weapons.js?v=20260708v';
import { authRequest } from './rpg/account.js?v=20260708v';
import { MobField } from './rpg/mobs.js?v=20260708v';
import { Inventory } from './rpg/loot.js?v=20260708v';
import { HUD, Progress, QuestLog } from './rpg/hud.js?v=20260708v';
import { Combat } from './rpg/combat.js?v=20260708v';
import { applyWeaponTier, makeCharAura, updateAura } from './rpg/fx.js?v=20260708v';
import { Effects } from './rpg/effects.js?v=20260708v';
import { attachWeaponByName } from './weapons.js?v=20260708v';
import { createTextureKit, createToonSkyTexture, createGroundVariationTexture } from './worldmat.js?v=20260708v';
import { buildPoiSigns, installPoiInteractions, loadPublicPois } from './pois.js?v=20260708v';
import { createTrailerMode, createTrailerNet, getTrailerAuth, getTrailerChoice, getTrailerConfig } from './trailer.js?v=20260708v';
import { SocialPanel } from './social.js?v=20260708v';
import { SkillSystem } from './rpg/skills.js?v=20260708v';
import { rollDrops, Wallet } from './rpg/economy.js?v=20260708v';
import { createSfx } from './sfx.js?v=20260708v';
import { installTouchControls } from './touch.js?v=20260708v';
import { createIntroScene } from './introscene.js?v=20260708v';

const APP_VERSION = '20260708v';
