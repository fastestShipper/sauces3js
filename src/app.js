...
import { City, mulberry32, ROAD_Y, WALK_Y, cropZoneData, WORLD_ANCHOR, WORLD_RADIUS } from './citygen.js?v=20260708u';
import { buildBuildings, buildRoads, buildParks } from './citymesh.js?v=20260708u';
import { GrassSystem } from './veg/grass.js?v=20260708u';
import { buildFlowerTuft } from './veg/flowers.js?v=20260708u';
import { Player } from './player.js?v=20260708u';
import { MiniMap } from './minimap.js?v=20260708u';
import { StreetLife } from './npcs.js?v=20260708u';
import { sanitizeImported } from './glbutil.js?v=20260708u';
import { buildToonLamp, buildToonBench, buildToonHydrant, buildToonBin, buildToonStreetSign, buildToonPlanter } from './props.js?v=20260708u';
import { Net } from './net.js?v=20260708u';
import { ChatUI, showBubble } from './chat.js?v=20260708u';
import { CLASS_LIST, CERNUNNOS, classById } from './rpg/classes.js?v=20260708u';
import { composeCharacter, sanitizeCustom, defaultCustom, RIGS, RIG_IDS, ACCESSORIES, ACC_IDS, PALETTES_BY_CLASS } from './rpg/charcustom.js?v=20260708u';
import { equipWeapon } from './weapons.js?v=20260708u';
import { authRequest } from './rpg/account.js?v=20260708u';
import { MobField } from './rpg/mobs.js?v=20260708u';
import { Inventory } from './rpg/loot.js?v=20260708u';
import { HUD, Progress, QuestLog } from './rpg/hud.js?v=20260708u';
import { Combat } from './rpg/combat.js?v=20260708u';
import { applyWeaponTier, makeCharAura, updateAura } from './rpg/fx.js?v=20260708u';
import { Effects } from './rpg/effects.js?v=20260708u';
import { attachWeaponByName } from './weapons.js?v=20260708u';
import { createTextureKit, createToonSkyTexture, createGroundVariationTexture } from './worldmat.js?v=20260708u';
import { buildPoiSigns, installPoiInteractions, loadPublicPois } from './pois.js?v=20260708u';
import { createTrailerMode, createTrailerNet, getTrailerAuth, getTrailerChoice, getTrailerConfig } from './trailer.js?v=20260708u';
import { SocialPanel } from './social.js?v=20260708u';
import { SkillSystem } from './rpg/skills.js?v=20260708u';
import { rollDrops, Wallet } from './rpg/economy.js?v=20260708u';
import { createSfx } from './sfx.js?v=20260708u';
import { installTouchControls } from './touch.js?v=20260708u';
import { createIntroScene } from './introscene.js?v=20260708u';

const APP_VERSION = '20260708u';
