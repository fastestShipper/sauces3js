...
import { City, mulberry32, ROAD_Y, WALK_Y, cropZoneData, WORLD_ANCHOR, WORLD_RADIUS } from './citygen.js?v=20260709c';
import { buildBuildings, buildRoads, buildParks } from './citymesh.js?v=20260709c';
import { GrassSystem } from './veg/grass.js?v=20260709c';
import { buildFlowerTuft } from './veg/flowers.js?v=20260709c';
import { Player } from './player.js?v=20260709c';
import { MiniMap } from './minimap.js?v=20260709c';
import { StreetLife } from './npcs.js?v=20260709c';
import { sanitizeImported } from './glbutil.js?v=20260709c';
import { buildToonLamp, buildToonBench, buildToonHydrant, buildToonBin, buildToonStreetSign, buildToonPlanter } from './props.js?v=20260709c';
import { Net } from './net.js?v=20260709c';
import { ChatUI, showBubble } from './chat.js?v=20260709c';
import { CLASS_LIST, CERNUNNOS, classById } from './rpg/classes.js?v=20260709c';
import { composeCharacter, sanitizeCustom, defaultCustom, RIGS, RIG_IDS, ACCESSORIES, ACC_IDS, PALETTES_BY_CLASS } from './rpg/charcustom.js?v=20260709c';
import { equipWeapon } from './weapons.js?v=20260709c';
import { authRequest } from './rpg/account.js?v=20260709c';
import { MobField } from './rpg/mobs.js?v=20260709c';
import { Inventory } from './rpg/loot.js?v=20260709c';
import { HUD, Progress, QuestLog } from './rpg/hud.js?v=20260709c';
import { Combat } from './rpg/combat.js?v=20260709c';
import { applyWeaponTier, makeCharAura, updateAura } from './rpg/fx.js?v=20260709c';
import { Effects } from './rpg/effects.js?v=20260709c';
import { attachWeaponByName } from './weapons.js?v=20260709c';
import { createTextureKit, createToonSkyTexture, createGroundVariationTexture } from './worldmat.js?v=20260709c';
import { buildPoiSigns, installPoiInteractions, loadPublicPois } from './pois.js?v=20260709c';
import { createTrailerMode, createTrailerNet, getTrailerAuth, getTrailerChoice, getTrailerConfig } from './trailer.js?v=20260709c';
import { SocialPanel } from './social.js?v=20260709c';
import { SkillSystem } from './rpg/skills.js?v=20260709c';
import { rollDrops, Wallet } from './rpg/economy.js?v=20260709c';
import { createSfx } from './sfx.js?v=20260709c';
import { installTouchControls } from './touch.js?v=20260709c';
import { createIntroScene } from './introscene.js?v=20260709c';
