...
import { City, mulberry32, ROAD_Y, WALK_Y, cropZoneData, WORLD_ANCHOR, WORLD_RADIUS } from './citygen.js?v=20260709d';
import { buildBuildings, buildRoads, buildParks } from './citymesh.js?v=20260709d';
import { GrassSystem } from './veg/grass.js?v=20260709d';
import { buildFlowerTuft } from './veg/flowers.js?v=20260709d';
import { Player } from './player.js?v=20260709d';
import { MiniMap } from './minimap.js?v=20260709d';
import { StreetLife } from './npcs.js?v=20260709d';
import { sanitizeImported } from './glbutil.js?v=20260709d';
import { buildToonLamp, buildToonBench, buildToonHydrant, buildToonBin, buildToonStreetSign, buildToonPlanter } from './props.js?v=20260709d';
import { Net } from './net.js?v=20260709d';
import { ChatUI, showBubble } from './chat.js?v=20260709d';
import { CLASS_LIST, CERNUNNOS, classById } from './rpg/classes.js?v=20260709d';
import { composeCharacter, sanitizeCustom, defaultCustom, RIGS, RIG_IDS, ACCESSORIES, ACC_IDS, PALETTES_BY_CLASS } from './rpg/charcustom.js?v=20260709d';
import { equipWeapon } from './weapons.js?v=20260709d';
import { authRequest } from './rpg/account.js?v=20260709d';
import { MobField } from './rpg/mobs.js?v=20260709d';
import { Inventory } from './rpg/loot.js?v=20260709d';
import { HUD, Progress, QuestLog } from './rpg/hud.js?v=20260709d';
import { Combat } from './rpg/combat.js?v=20260709d';
import { applyWeaponTier, makeCharAura, updateAura } from './rpg/fx.js?v=20260709d';
import { Effects } from './rpg/effects.js?v=20260709d';
import { attachWeaponByName } from './weapons.js?v=20260709d';
import { createTextureKit, createToonSkyTexture, createGroundVariationTexture } from './worldmat.js?v=20260709d';
import { buildPoiSigns, installPoiInteractions, loadPublicPois } from './pois.js?v=20260709d';
import { createTrailerMode, createTrailerNet, getTrailerAuth, getTrailerChoice, getTrailerConfig } from './trailer.js?v=20260709d';
import { SocialPanel } from './social.js?v=20260709d';
import { SkillSystem } from './rpg/skills.js?v=20260709d';
import { rollDrops, Wallet } from './rpg/economy.js?v=20260709d';
import { createSfx } from './sfx.js?v=20260709d';
import { installTouchControls } from './touch.js?v=20260709d';
import { createIntroScene } from './introscene.js?v=20260709d';
