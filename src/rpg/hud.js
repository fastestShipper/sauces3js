...
.rpg-hud-panel { position: fixed; background: linear-gradient(135deg, rgba(26,48,32,.72), rgba(10,24,14,.84));
...
.rpg-hud-lvl-badge { position: absolute; left: 8px; top: 50%; transform: translateY(-50%);
  ...
  background: linear-gradient(135deg, #a8e063, #2f9e5f); color: #fff; text-shadow: 0 1px 2px rgba(16,70,36,.5);
