...
assert.match(app, /const APP_VERSION = '20260710g50';/, 'app version stamp is unchanged');
assert.match(trailer, /\?v=20260710g50/g, 'existing import stamps remain unchanged');
